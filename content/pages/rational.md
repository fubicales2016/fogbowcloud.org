...
Different from a rainbow that displays a bright continuos sprectum of colors, a fogbow has only very weak colors, with a red outer edge and bluish inner edge. This is because the fog water drops are much smaller than the large drops in the rain.

A fogbow targets the federation of small and medium size IaaS providers, rather than large ones. Moreover, although it is possible to appreciate its distinct rings (federation, opportunism and greenness) in separate, they are often blured one in the other.
